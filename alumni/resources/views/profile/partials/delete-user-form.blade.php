<section class="space-y-6">
    <header class="flex items-start gap-3 pb-5 border-b border-red-100">
        <span class="h-10 w-10 rounded-xl bg-red-100 text-red-700 flex items-center justify-center shrink-0">
